...
function FlightCard(props) {
  ...
  let bgCol = "white";
  if (props.isSelected(flight._id, cabin) || props.onClick === null)
    bgCol = selectedColor;
      ...
      <CardActionArea
        onClick={() => {
          if (props.onClick != null) {
            if (props.isSelected(flight._id, cabin)) props.onClick(null, null);
            else props.onClick(flight, props.cabin);
          }
        }}
      >
        <CardContent>
          ...
          <div id="dep" ref={ref1} className="item1">
            {" "}
            <h2> {flight.DepartureCity} </h2>
            <h4 className="depair">
              {" "}
              {flight.DepartureAirport}
              <div className={classes.arrIcon}>
                {" "}
                <FlightTakeoffIcon />
              </div>
            </h4>
          ...
          <div id="arr" ref={ref2} class="item2">
            {" "}
      ...
      <Collapse in={expanded || props.perm} timeout="auto" unmountOnExit>
        <div className="details" style={mystyle}>
          <div className="attribute">
            ...
            <h4 class="arricon"> {flight.BaggageAllowance} Kg </h4>
          </div>
          ...
          <div className="attribute">
            ...
            <h4 class="arricon"> {flight.EconomyPrice * multiplier} </h4>
          </div>
          ...
          <div className="attribute">
            ...
            <h4 class="arricon"> {seats} available seats </h4>
          </div>
        </div>
      </Collapse>
    </Card>
